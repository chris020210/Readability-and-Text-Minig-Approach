...
quantile(unlist(MPM_BOOTS_INTERVALS[,"t-stat"]), c(.01, 0.025, .05, .1, .25, .5, .75, .95, 0.9725 ,.99))
quantile(unlist(MPM_BOOTS_INTERVALS[,"First break"]), c(.01, 0.025, .05, .1, .25, .5, .75, .95, 0.9725 ,.99))
quantile(unlist(MPM_BOOTS_INTERVALS[,"Second break"]), c(.01, 0.025, .05, .1, .25, .5, .75, .95, 0.9725 ,.99))
```
...
#MPD_BOOTS_RESULTS
A <- test.results.y <-  ur.ls.bootstrap(y=as.numeric(na.omit(MPD_MAFSZ)) , model = "crash", breaks = 2, lags = 8, method = "Fixed",pn = 0.1, critval = "bootstrap", print.results = "print")
...
quantile(unlist(MPD_BOOTS_INTERVALS[,"t-stat"]), c(.01, 0.025, .05, .1, .25, .5, .75, .95, 0.9725 ,.99))
quantile(unlist(MPD_BOOTS_INTERVALS[,"First break"]), c(.01, 0.025, .05, .1, .25, .5, .75, .95, 0.9725 ,.99))
quantile(unlist(MPD_BOOTS_INTERVALS[,"Second break"]), c(.01, 0.025, .05, .1, .25, .5, .75, .95, 0.9725 ,.99))
```
