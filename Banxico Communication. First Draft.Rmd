...
```{r Table 4 Average readability of Banco de Méxicos publications,echo=FALSE, message=FALSE, warning=FALSE}
...
\noindent
```{r Figure 6 LOCF data, echo=FALSE, message=FALSE, warning=FALSE}
...
Table 5 shows the results of applying an _innovational outlier model_ break selection for the ZA and PV tests. The later means that we assume a gradual rather than a sudden change (_additive outlier model_) in the GDP of the series. 
...
knitr::kable(Clasic_Unit,
    ...
    add_footnote(c("Source: Author's calculation.","Note: rejection of the null at (*)1%, (**)5%, (***)10% level.","Number in parenthesis after the test are the selected lags.","Number in parentheis below the t-statics represents the correspondent p-values"),
                 notation = "none",
                 threeparttable = F)
