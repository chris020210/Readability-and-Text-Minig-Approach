...
FLESCH.SCALE <- data.frame("Score" = c(100,95,90,85,80,75,70,65,60,55,50,
                           ...
                           "Fernández Huerta" =c(rep("Very easy",2), rep("Easy", 2),
                                        ...
                                        rep("Difficult",4), rep("Very difficult",3)))
#library(openxlsx)
write.xlsx(FLESCH.SCALE, "Legibilidad.xlsx")
...
FIGURE5$Governor[COR$Year %in% 2011:2017] = "Agustín Carstens"
FIGURE5$Governor[c(140,141)] = "Alejandro Díaz de León"
FIGURE5$Governor[COR$Year %in% 2018:2021] = "Alejandro Díaz de León"
FIGURE5$Governor[COR$Year %in%2022] = "Victoria Rodríguez"


FIGURE5<-cor(FIGURE5[,4:9])
...
```{r eval=FALSE, include=FALSE}
library(openxlsx)
FIGURES <- list(Figure1 = Figure1,
                FIGURE2 = FIGURE2[,c(1,2,29,31,32)],
                FIGURE4 = FIGURE4[,c(1,2,11,12,22)],
                CENSUS_EDUC_LEV = CENSUS_EDUC_LEV,
                ...
                TB2 = TB2,
                TB21 = TB21)
write.xlsx(FIGURES, "figures.xlsx")
save(FIGURES, file = "FIGURES.RData")
```
