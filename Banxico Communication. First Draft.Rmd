...
During the 2010s, a number of works focused on communication and its application in the framework of ZLB in developed countries emerged[^17]. At the same time, new research has concentrated on the implementation of text mining and text analysis tools. The latter, by a Natural Language approach (NLP) try to decipher the clarity and semantic content of central banks communication. A seminal contribution can be found in Boukus and Rosenberg (2006)[^18]:
...
[^18]: See [Boukus and Rosenberg (2006).](https://www.newyorkfed.org/medialibrary/media/research/economists/rosenberg/Boukus_and_Rosenberg_072006.pdf).
