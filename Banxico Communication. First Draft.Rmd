...
[^1]: See Fry et al. (2000), Blinder et al. (2001), Geraats (2002; 2006), Eijffinger and Geraats (2006), Cujisen and Dermertzis (2007), Dincer and Eichengreen (2009; 2014), Kedan and Stuart (2014), Dincer, Eichengreen, y Geraats (2019; 2022)
...
The work of Christina and David Romer (1989)[^8] represents a seminal contribution to communication literature. Applying the so-called _narrative approach_, they investigate a set of periods in which the Federal Reserve's wording was restrictive to study its relationship to the real effects of monetary shocks. They find that narratives, i.e., the historical record, such as descriptions of the process and reasoning that led to the monetary authority's decisions and accounts of the sources of monetary disturbances, can solve the problem of identifying multiple macroeconomic issues.
...
That same year, Alan Greenspan - who had previously declared himself to "mumble with great incoherence" - recognized the importance of transparency and communication with the public[^11]:
...
Already in the 2000s, in a thorough analysis, Kohn and Sack (2004)[^12] showed that the central bank's talk contain market-relevant information. By testing for volatility in asset prices due to different types of Federal Reserve speaks, they found that statements and policy actions can serve as effective substitutes for one another, at least in the short run. Their analysis conclude that a credible central bank can achieve nearly the same result by implementing a policy action or by promising to implement that action at the next meeting.

[^12]: See [Kohn and Sack (2004).](https://www.federalreserve.gov/pubs/feds/2003/200355/200355pap.pdf)

Ben Bernanke, during his time at the Federal Reserve, constantly advocated for greater transparency, communication and the formal adoption of inflation targeting. Indeed, following the early experience of the Bank of Japan, his paper co-authored with Vincent Reinhart and Brian Sack (2004)[^13] was one of the first to conclude that when monetary authority is constrained by the Zero Lower Bound, unconventional measures, such as communication and forward guidance, can successfully affect expectations of future policy and thus longer-term yields.

[^13]: See [Bernanke, Reinhart and Sack (2004).](https://www.federalreserve.gov/pubs/feds/2004/200448/200448pap.pdf)

After this first generation of empirical studies, Blinder et al. (2008)[^14] surveyed the literature existent at the time, pointing out that even when there was no evident consensus about the optimal communication policy, "communication can be an important and powerful part of the central bank’s toolkit since it has the ability to move financial markets, to improve the predictability of monetary policy, and the potential to help the monetary authorities achieve macroeconomic objectives such as low and stable inflation".

[^14]: See [Blinder, Ehrmann, Fratzscher, De Haan and Jansen (2008).](https://www.ecb.europa.eu/pub/pdf/scpwps/ecbwp898.pdf)


Despite growing evidence of the benefits of transparency and communication, it was not until the Global Financial Crisis (GFC) that major central banks began to formally introduce communication tools as part of their toolkit.[^15] Since then, in the literature and the world of central banking, there is a clear consensus regarding the role of communication tools in indirectly influencing the yield curve. While the policy rate is seen as the primary tool to influence directly very short-term interest rates, the central bank's communication generally is seen as a supportive tool that can influence long-term interest rates. This management of expectations approach was widely adopted by major central banks and other emerging markets authorities during the GFC due to primary tools constricted by the Zero Lower Bound (ZLB)[^16], the growing importance of financial stability, and better understanding on how market expectations can affect market prices.

[^15]: See [Bernanke (2022).](https://wwnorton.com/books/9781324020462)

[^16]: For instance see [Den Haan, Caselli, Chadha  and Armstrong (2015).](https://cepr.org/voxeu/columns/monetary-policy-zero-lower-bound)

The growing power of monetary authorities and the importance of market expectations in the transmission of monetary policy has yielded new definitions of monetary policy strategy and the central banker toolkit. In the aftermath of the GFC, the central bank's role has been characterized by an increase in procedural transparency and an evolution of clarity in communication. With the development of communication tools, a lot of literature has emerged trying to understand the impact of central bank's communication on market expectations, signals on the yield curve, and the effective transmission of monetary policy.[^16]

Campbell et al. (2012) and Campbell (2013), using both an empirical an theoretical approach, showed how the Fed, through public announcements and forward guidance, can successfully influence assets prices and forecast over a variety of many macroeconomics variables. Their work also derived in new definitions of communication and the types of forward guidance a monetary authority can deliver.[^16]

[^16]: See [Campbell et al. (2012)](https://www.brookings.edu/wp-content/uploads/2012/03/2012a_evans.pdf) and [Campbell (2013).](https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&ved=2ahUKEwicl8WV7bb-AhVllGoFHV14DzMQFnoECAsQAQ&url=https%3A%2F%2Fwww.chicagofed.org%2F~%2Fmedia%2Fpublications%2Feconomic-perspectives%2F2013%2F4q2013-part1-campbell-pdf.pdf&usg=AOvVaw1SCPs_bzDS02Gmsl3nTnwk)

During the 2010s, a number of works focused on communication and its application in the framework of ZLB in developed countries emerged[^17]. At the same time, new research has concentrated on the implementation of text mining and text analysis tools. The latter, by Natural Language Processing (NLP) and Latent Semantic Analysis (LSA) aim to decipher the clarity and semantic content of central banks communication. For instance, Boukus and Rosenberg (2006) found that topics discuss in the minutes of the Federal Open Market Committee  (FOMC) are correlated with current and future economic conditions. Jedadesh and Wu (2015) show evidence that the Fed possessing superior information, which is transmitted to the market through the text of the minutes. Husted, Rogers and Sun (2020) 

[^17]: See [Charbonneau and Rennison (2015).](https://www.bankofcanada.ca/2015/11/staff-discussion-paper-2015-15/), [Smith and Becker (2015)](https://www.kansascityfed.org/Economic%20Bulletin/documents/412/macrobulletins-Has%20Forward%20Guidance%20Been%20Effective%3F.pdf), [McKay, Nakamura, and Steinsson (2016)](https://www.aeaweb.org/articles?id=10.1257/aer.20150063), [Angeletos, George-Marios, and Chen Lian (2018)](https://www.aeaweb.org/articles?id=10.1257/aer.20161996), [Dell'Ariccia, Rabanal and Sandri (2018)](https://www.aeaweb.org/articles?id=10.1257/jep.32.4.147), [Altavilla, Brugnolini, Gürkaynak, Motto and Ragusa (2019)](https://www.sciencedirect.com/science/article/pii/S0304393219301497), [Bernanke, Kiley and Roberts (2019)](https://www.aeaweb.org/articles?id=10.1257/pandp.20191082), [Bernanke (2020)](https://www.aeaweb.org/articles?id=10.1257/aer.110.4.943),  

[^18]: See [Boukus and Rosenberg (2006)](https://www.newyorkfed.org/medialibrary/media/research/economists/rosenberg/Boukus_and_Rosenberg_072006.pdf), [Jedadesh and Wu (2015)](https://www.aeaweb.org/conference/2016/retrieve.php?pdfid=21466&tk=niAkBk3N), [Husted, Rogers and Sun (2020)](https://www.sciencedirect.com/science/article/abs/pii/S0304393218301661?casa_token=ZWe2yDS3yaYAAAAA:jfOt4hzdUkHyfs1777TVFhx75YsQko2rpcWkTcRvZHbOKu2enlZMDYCl-amksw0RI0vue2aq7Wgd), []()

, Taborda (2015), , Kahveci and Odabas (2016), Luangaram and Wongwachara (2016), Benchimol et al. (2020), Carotta et al. (2021), Casigaghi and Pio Perez (2022), Benchimol et al (2022).
