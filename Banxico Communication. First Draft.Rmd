...
The changes that originated, both in theory and practice, triggered a radical transformation toward greater independence. This included the adoption of inflation targeting schemes, which sought to anchor inflation expectations by publicly announcing a numerical target for inflation. This allowed central banks to set clearer and more specific targets, and to gain credibility on them. All of these changes were a significant departure from the past, where central banks often kept their goals and methods of operation secret.

While in the 1980s and 1990s the debate was about central bank independence and inflation targets, the growing power of central banks set the need for opennes and accountancy. Therefore, the 2000s saw the emergence of quite a bit of literature focused on the transparency of monetary authorities and central bank's communication channels.
...
Finally, in May 2022 the Board of Directors took a major step by formally delivering _Odyssean forward guidance_ in the monetary policy statements.[^26] Table 1 summarizes the evolution of Banxico's communication strategy.

[^26]: See [Campbell (2013)](https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&ved=2ahUKEwicl8WV7bb-AhVllGoFHV14DzMQFnoECAsQAQ&url=https%3A%2F%2Fwww.chicagofed.org%2F~%2Fmedia%2Fpublications%2Feconomic-perspectives%2F2013%2F4q2013-part1-campbell-pdf.pdf&usg=AOvVaw1SCPs_bzDS02Gmsl3nTnwk).
...
A%>%
  ...
  geom_line(size = 0.7)+
    ...
    y = " ",
    color = " ",
    caption = "**Figure 2**: Readability of Banco de México Over Time.<br><br>Source: Author's calculation.<br>Note: The average was calculated using the standard mean at each time position of the three readability<br>measures. The Gutierrez score was scaled to fit the other two measures. he dashed lines correspond to<br>the respect readability level on the INFLESZ scale.")+
  theme_tufte(base_family = "serif",
            base_size = 12)+
  scale_color_wsj()+
...
A$type <- c("-","Dissemination","-","Literature",
...
\noindent
```{r Figure 3  Scatter Plots, eval=FALSE, fig.height=4, fig.width=6, message=FALSE, warning=FALSE, include=FALSE}
