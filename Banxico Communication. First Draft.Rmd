...
A<-knitr::kable(Banxico_Communication,
  ...
  kable_styling(font_size = 10 ,latex_options = c(),
                full_width = T) %>%
...
This information, together with the facts reviewed in the previous section, leads us to consider that the levels of clarity have suffered possible structural breaks in the period between 2011 and 2022.
